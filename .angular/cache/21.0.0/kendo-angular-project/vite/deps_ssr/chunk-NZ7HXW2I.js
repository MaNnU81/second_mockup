...
var NavigationService = class _NavigationService {
  localization;
  expands = new import_rxjs.Subject();
  moves = new import_rxjs.Subject();
  checks = new import_rxjs.Subject();
  selects = new import_rxjs.Subject();
  deselectAllButCurrentItem = new import_rxjs.Subject();
  loadMore = new import_rxjs.Subject();
  navigable = true;
  selection = "single";
...
var TreeViewGroupComponent = class _TreeViewGroupComponent {
  ...
  singleRecordSubscriptions = new import_rxjs.Subscription();
...
var TreeViewComponent = class _TreeViewComponent {
  ...
  selectable = false;
  touchActions = true;
  data = new import_rxjs.BehaviorSubject([]);
  _animate = true;
  _isChecked;
  _isExpanded;
  _isSelected;
...
var ExpandDirective = class _ExpandDirective {
  ...
  constructor(component) {
    ...
    this.subscriptions.add((0, import_rxjs.merge)(this.component.expand.pipe((0, import_operators.map)((e) => __spreadValues({
      expand: true
    }, e))), this.component.collapse.pipe((0, import_operators.map)((e) => __spreadValues({
      expand: false
...
var AutoCompleteComponent = class _AutoCompleteComponent {
  ...
  */
  ...
  backspacePressed;
  subs = new import_rxjs2.Subscription();
  valueChangeSubject = new import_rxjs2.Subject();
...
var ComboBoxComponent = class _ComboBoxComponent extends MultiTabStop {
   ...
   * ```
   */
  valueNormalizer = (text) => text.pipe((0, import_operators2.map)((userInput) => userInput));
  /**
  ...
  _virtualSettings;
  popupMouseDownHandler = (event) => event.preventDefault();
  customValueSubject = new import_rxjs2.Subject();
  valueSubject = new import_rxjs2.Subject();
  clearValueSubject = new import_rxjs2.Subject();
  direction;
  subs = new import_rxjs2.Subscription();
  touchstartDisposeHandler;
  ...
  attachStreams() {
    ...
    this.subs.add((0, import_rxjs2.merge)(this.selectionService.onChange, this.selectionService.onSelect.pipe((0, import_operators2.filter)(() => !this.isOpen))).pipe((0, import_operators2.tap)(() => {
      this._filtering = false;
      this.togglePopup(false);
    }), (0, import_operators2.map)((event) => this.dataService.itemAt(event.indices[0]))).subscribe((dataItem) => {
      this.change(dataItem);
    }));
    this.subs.add(this.selectionService.onSelect.pipe((0, import_operators2.filter)(() => this.isOpen), (0, import_operators2.tap)(() => this._filtering = false), (0, import_operators2.map)((event) => this.dataService.itemAt(event.indices[0]))).subscribe((dataItem) => {
...
var DropDownListComponent = class _DropDownListComponent {
  ...
  */
  ...
  subscribeEvents() {
    ...
    this.subs.add(this.selectionService.onSelect.pipe((0, import_operators2.filter)(() => this.isOpen), (0, import_operators2.map)(this.itemFromEvent.bind(this))).subscribe(this.onSelectionChange.bind(this)));
    this.subs.add((0, import_rxjs2.merge)(this.selectionService.onSelect.pipe((0, import_operators2.filter)(() => !this.isOpen)), this.selectionService.onChange).pipe((0, import_operators2.map)(this.itemFromEvent.bind(this)), (0, import_operators2.tap)(() => this.togglePopup(false))).subscribe(({
      dataItem,
      value: newValue,
      newSelection
    }) => {
...
var MultiSelectComponent = class _MultiSelectComponent {
   ...
   */
  valueNormalizer = (text) => text.pipe((0, import_operators2.map)((userInput) => {
...
var MultiColumnComboBoxComponent = class _MultiColumnComboBoxComponent extends ComboBoxComponent {
  ...
  set headerTable(headerTable) {
    ...
    if (this.headerTable) {
      this.zone.onStable.pipe((0, import_operators2.take)(1)).subscribe(() => {
  ...
  columnsChangeSubscription = new import_rxjs2.Subscription();
  /**
   * @hidden
   */
  get tableSizeClass() {
...
var DropDownTreeComponent = class _DropDownTreeComponent {
  ...
  */
  ...
  _searchableNodes = [];
  _typedValue = "";
  printableCharacters = new import_rxjs2.Subject();
  subs = new import_rxjs2.Subscription();
  touchstartDisposeHandler;
  ...
  */
  ...
  subscribeEvents() {
    [this.navigationService.open.subscribe((event) => {
      event.originalEvent.preventDefault();
      this.togglePopup(true);
    }), this.navigationService.enter.pipe((0, import_operators2.tap)((event) => event.originalEvent.preventDefault())).subscribe(() => this.togglePopup(true)), (0, import_rxjs2.merge)(this.navigationService.close).subscribe((event) => {
      event.originalEvent.preventDefault();
      this.focus();
      this.togglePopup(false);
...
//# sourceMappingURL=chunk-NZ7HXW2I.js.map
