...
var ActionSheetComponent = class _ActionSheetComponent {
  ...
  dynamicRTLSubscription;
  rtl = false;
  domSubs = new import_rxjs.Subscription();
  player;
...
var BreadCrumbListComponent = class _BreadCrumbListComponent {
  ...
  constructor(el, zone) {
    ...
    this.zone.runOutsideAngular(() => {
      ...
      const enterKey$ = (0, import_rxjs.fromEvent)(element, "keydown").pipe((0, import_operators.filter)((ev) => ev.code === Keys.Enter || ev.code === Keys.NumpadEnter));
...
var BreadCrumbComponent = class _BreadCrumbComponent {
  ...
  _collapseMode = "auto";
  _size = DEFAULT_SIZE;
  updateItems = new import_rxjs.ReplaySubject();
  afterViewInit = new import_rxjs.Subject();
  subscriptions = new import_rxjs.Subscription();
  direction = "ltr";
...
var AdaptiveService = class _AdaptiveService {
   ...
   * @hidden
   */
  changes = new import_rxjs2.BehaviorSubject(this.adaptiveSettings || {
    small: 500,
    medium: 700
  });
  /**
   ...
   * @hidden
   */
  sizeChanges = new import_rxjs2.BehaviorSubject(this.size);
  ...
  constructor(_adaptiveSettings, adaptiveSettingsService, zone) {
    ...
    if (adaptiveSettingsService) {
      this.subs.add(adaptiveSettingsService.changes.pipe((0, import_operators2.map)((adaptiveSettings) => isPresent(adaptiveSettings) ? adaptiveSettings : this._adaptiveSettings), (0, import_operators2.tap)((adaptiveSettings) => this._adaptiveSettings = adaptiveSettings)).subscribe((adaptiveSettings) => this.changes.next(adaptiveSettings)));
    }
    ...
    if (isDocumentAvailable()) {
      this.zone.runOutsideAngular(() => {
        this.subs.add((0, import_rxjs2.fromEvent)(window, "resize").pipe((0, import_operators2.tap)(() => !this.previousSize && (this.previousSize = this.size)), (0, import_operators2.filter)(() => this.previousSize !== this.size)).subscribe(() => {
...
//# sourceMappingURL=chunk-EZ7XYBQF.js.map
