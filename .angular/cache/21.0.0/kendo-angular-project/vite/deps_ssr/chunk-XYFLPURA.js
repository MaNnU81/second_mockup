...
function WatermarkOverlayComponent_div_0_span_5_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelement(0, "span", 9);
  }
  if (rf & 2) {
...
function WatermarkOverlayComponent_div_0_span_6_Template(rf, ctx) {
  if (rf & 1) {
...
function WatermarkOverlayComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵelement(4, "path", 4);
    ɵɵelementEnd()();
    ɵɵtemplate(5, WatermarkOverlayComponent_div_0_span_5_Template, 1, 1, "span", 5)(6, WatermarkOverlayComponent_div_0_span_6_Template, 5, 1, "span", 6);
    ɵɵnamespaceHTML();
    ɵɵelementStart(7, "div", 2)(8, "button", 7);
    ɵɵlistener("click", function WatermarkOverlayComponent_div_0_Template_button_click_8_listener() {
      ɵɵrestoreView(_r1);
  ...
  if (rf & 2) {
    ...
    ɵɵadvance(3);
    ɵɵproperty("ngIf", ctx_r1.licenseMessage);
    ɵɵadvance();
    ɵɵproperty("ngIf", !ctx_r1.licenseMessage);
    ɵɵadvance();
...
var WatermarkOverlayComponent = class _WatermarkOverlayComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    decls: 1,
    vars: 1,
    consts: [["banner", ""], [3, "ngStyle", 4, "ngIf"], [3, "ngStyle"], ["width", "16", "height", "16", "viewBox", "0 0 16 16", "fill", "none"], ["fill-rule", "evenodd", "clip-rule", "evenodd", "d", "M8 1L0 15H16L8 1ZM7 6V11H9V6H7ZM7 14V12H9V14H7Z", "fill", "#1E1E1E"], [3, "innerHtml", 4, "ngIf"], [4, "ngIf"], ["title", "Close", 3, "click", "ngStyle"], ["d", "M13 4.41562L9.41563 8L13 11.5844L11.5844 13L8 9.41563L4.41562 13L3 11.5844L6.58437 8L3 4.41562L4.41562 3L8 6.58437L11.5844 3L13 4.41562Z", "fill", "#1E1E1E"], [3, "innerHtml"], [3, "href"]],
    template: function WatermarkOverlayComponent_Template(rf, ctx) {
      if (rf & 1) {
        ɵɵtemplate(0, WatermarkOverlayComponent_div_0_Template, 11, 8, "div", 1);
      }
      if (rf & 2) {
...
//# sourceMappingURL=chunk-XYFLPURA.js.map
