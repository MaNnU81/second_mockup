  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    consts: () => {
      ...
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG_C__USERS_GIOVANNIMARIA_SUSSAR_DOCUMENTS_MOCKUP_KENDO_SECOND_MOCKUP_NODE_MODULES__PROGRESS_KENDO_ANGULAR_PROGRESSBAR_FESM2022_PROGRESS_KENDO_ANGULAR_PROGRESSBAR_MJS_0 = goog.getMsg("Progressbar");
        i18n_0 = MSG_C__USERS_GIOVANNIMARIA_SUSSAR_DOCUMENTS_MOCKUP_KENDO_SECOND_MOCKUP_NODE_MODULES__PROGRESS_KENDO_ANGULAR_PROGRESSBAR_FESM2022_PROGRESS_KENDO_ANGULAR_PROGRESSBAR_MJS_0;
      } else {
...
var ChunkProgressBarComponent = class _ChunkProgressBarComponent extends ProgressBarBase {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    consts: () => {
      let i18n_1;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG_C__USERS_GIOVANNIMARIA_SUSSAR_DOCUMENTS_MOCKUP_KENDO_SECOND_MOCKUP_NODE_MODULES__PROGRESS_KENDO_ANGULAR_PROGRESSBAR_FESM2022_PROGRESS_KENDO_ANGULAR_PROGRESSBAR_MJS_1 = goog.getMsg("Chunk progressbar");
        i18n_1 = MSG_C__USERS_GIOVANNIMARIA_SUSSAR_DOCUMENTS_MOCKUP_KENDO_SECOND_MOCKUP_NODE_MODULES__PROGRESS_KENDO_ANGULAR_PROGRESSBAR_FESM2022_PROGRESS_KENDO_ANGULAR_PROGRESSBAR_MJS_1;
      } else {
...
var CircularProgressBarComponent = class _CircularProgressBarComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    consts: () => {
      let i18n_2;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG_C__USERS_GIOVANNIMARIA_SUSSAR_DOCUMENTS_MOCKUP_KENDO_SECOND_MOCKUP_NODE_MODULES__PROGRESS_KENDO_ANGULAR_PROGRESSBAR_FESM2022_PROGRESS_KENDO_ANGULAR_PROGRESSBAR_MJS_2 = goog.getMsg("Circular progressbar");
        i18n_2 = MSG_C__USERS_GIOVANNIMARIA_SUSSAR_DOCUMENTS_MOCKUP_KENDO_SECOND_MOCKUP_NODE_MODULES__PROGRESS_KENDO_ANGULAR_PROGRESSBAR_FESM2022_PROGRESS_KENDO_ANGULAR_PROGRESSBAR_MJS_2;
      } else {
...
var PanelBarComponent = class _PanelBarComponent {
  ...
  eventService;
  keyBindings;
  subs = new import_rxjs2.Subscription();
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    decls: 3,
    vars: 3,
    consts: [[4, "ngIf"], [3, "ngIf"], ["kendoWatermarkOverlay", "", 3, "licenseMessage", 4, "ngIf"], [4, "ngFor", "ngForOf"], [3, "title", "id", "icon", "iconClass", "svgIcon", "imageUrl", "selected", "expanded", "disabled", "template", "items", "content", 4, "ngIf"], [3, "title", "id", "icon", "iconClass", "svgIcon", "imageUrl", "selected", "expanded", "disabled", "template", "items", "content"], ["kendoWatermarkOverlay", "", 3, "licenseMessage"]],
    template: function PanelBarComponent_Template(rf, ctx) {
      if (rf & 1) {
        ɵɵprojectionDef(_c22);
        ɵɵtemplate(0, PanelBarComponent_ng_content_0_Template, 1, 0, "ng-content", 0)(1, PanelBarComponent_ng_template_1_Template, 1, 1, "ng-template", 1)(2, PanelBarComponent_div_2_Template, 1, 1, "div", 2);
      }
      if (rf & 2) {
...
var ScrollService = class _ScrollService {
  ...
  owner;
  position = 0;
  scrollButtonActiveStateChange = new import_rxjs2.Subject();
  get tablistElement() {
...
var TabStripComponent = class _TabStripComponent {
  ...
  set size(value) {
    ...
    this._size = value;
    this.ngZone.onStable.pipe((0, import_operators2.take)(1)).subscribe(() => this.onResize());
  }
  get size() {
    return this._size;
  }
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    consts: () => {
      let i18n_0;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG_C__USERS_GIOVANNIMARIA_SUSSAR_DOCUMENTS_MOCKUP_KENDO_SECOND_MOCKUP_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2022_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_0 = goog.getMsg("Close");
        i18n_0 = MSG_C__USERS_GIOVANNIMARIA_SUSSAR_DOCUMENTS_MOCKUP_KENDO_SECOND_MOCKUP_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2022_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_0;
      } else {
        i18n_0 = $localize`:kendo.tabstrip.closeTitle|The title for the **Close** button in the TabStrip tab.:Close`;
      }
      let i18n_1;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG_C__USERS_GIOVANNIMARIA_SUSSAR_DOCUMENTS_MOCKUP_KENDO_SECOND_MOCKUP_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2022_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_1 = goog.getMsg("Previous Tab");
        i18n_1 = MSG_C__USERS_GIOVANNIMARIA_SUSSAR_DOCUMENTS_MOCKUP_KENDO_SECOND_MOCKUP_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2022_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_1;
      } else {
...
var DrawerComponent = class _DrawerComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    decls: 2,
    vars: 2,
    consts: [["class", "k-drawer-wrapper", 3, "width", 4, "ngIf"], ["kendoWatermarkOverlay", "", 3, "licenseMessage", 4, "ngIf"], [1, "k-drawer-wrapper"], [4, "ngIf"], ["kendoDrawerList", "", "role", "menubar", "aria-orientation", "vertical", 1, "k-drawer-items", 3, "select", "mini", "expanded", "view", "itemTemplate"], [3, "ngTemplateOutlet"], ["kendoWatermarkOverlay", "", 3, "licenseMessage"]],
    template: function DrawerComponent_Template(rf, ctx) {
      if (rf & 1) {
        ɵɵtemplate(0, DrawerComponent_div_0_Template, 3, 4, "div", 0)(1, DrawerComponent_div_1_Template, 1, 1, "div", 1);
      }
      if (rf & 2) {
  ...
  */
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    consts: () => {
      let i18n_3;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG_C__USERS_GIOVANNIMARIA_SUSSAR_DOCUMENTS_MOCKUP_KENDO_SECOND_MOCKUP_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2022_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_3 = goog.getMsg("Optional");
        i18n_3 = MSG_C__USERS_GIOVANNIMARIA_SUSSAR_DOCUMENTS_MOCKUP_KENDO_SECOND_MOCKUP_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2022_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_3;
      } else {
...
var AvatarComponent = class _AvatarComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    consts: () => {
      let i18n_4;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG_C__USERS_GIOVANNIMARIA_SUSSAR_DOCUMENTS_MOCKUP_KENDO_SECOND_MOCKUP_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2022_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_4 = goog.getMsg("Avatar");
        i18n_4 = MSG_C__USERS_GIOVANNIMARIA_SUSSAR_DOCUMENTS_MOCKUP_KENDO_SECOND_MOCKUP_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2022_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_4;
      } else {
    ...
    template: function AvatarComponent_Template(rf, ctx) {
      if (rf & 1) {
        ɵɵprojectionDef();
        ɵɵelementContainer(0, 0);
        ɵɵtemplate(1, AvatarComponent_ng_content_1_Template, 1, 0, "ng-content", 1)(2, AvatarComponent_ng_container_2_Template, 3, 4, "ng-container", 1)(3, AvatarComponent_ng_container_3_Template, 3, 2, "ng-container", 1)(4, AvatarComponent_ng_container_4_Template, 3, 4, "ng-container", 1);
      }
      if (rf & 2) {
        ɵɵadvance();
...
var TileLayoutDraggingService = class _TileLayoutDraggingService {
  ...
  cdr;
  localization;
  reorderable = new import_rxjs2.BehaviorSubject(null);
  resizable = new import_rxjs2.BehaviorSubject(null);
  reorder = new import_rxjs2.Subject();
  resize = new import_rxjs2.Subject();
  tileLayoutSettings;
  get colStart() {
...
var TileLayoutKeyboardNavigationService = class _TileLayoutKeyboardNavigationService {
  ...
  renderer;
  localization;
  navigable = new import_rxjs2.BehaviorSubject(true);
  owner;
  mousedown;
  localizationSubscription;
  rtl;
...
var TileLayoutComponent = class _TileLayoutComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    decls: 4,
    vars: 15,
    consts: [["hint", ""], [1, "k-layout-item-hint"], ["kendoWatermarkOverlay", "", 3, "licenseMessage", 4, "ngIf"], ["kendoWatermarkOverlay", "", 3, "licenseMessage"]],
    template: function TileLayoutComponent_Template(rf, ctx) {
      if (rf & 1) {
        ɵɵprojectionDef();
        ɵɵprojection(0);
        ɵɵelement(1, "div", 1, 0);
        ɵɵtemplate(3, TileLayoutComponent_div_3_Template, 1, 1, "div", 2);
      }
      if (rf & 2) {
        ɵɵadvance();
...
var TimelineComponent = class _TimelineComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    consts: () => {
      let i18n_5;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG_C__USERS_GIOVANNIMARIA_SUSSAR_DOCUMENTS_MOCKUP_KENDO_SECOND_MOCKUP_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2022_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_5 = goog.getMsg("previous");
        i18n_5 = MSG_C__USERS_GIOVANNIMARIA_SUSSAR_DOCUMENTS_MOCKUP_KENDO_SECOND_MOCKUP_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2022_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_5;
      } else {
        i18n_5 = $localize`:kendo.timeline.previous|The title of the previous button in horizontal orientation.:previous`;
      }
      let i18n_6;
      if (typeof ngI18nClosureMode !== "undefined" && ngI18nClosureMode) {
        const MSG_C__USERS_GIOVANNIMARIA_SUSSAR_DOCUMENTS_MOCKUP_KENDO_SECOND_MOCKUP_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2022_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_6 = goog.getMsg("next");
        i18n_6 = MSG_C__USERS_GIOVANNIMARIA_SUSSAR_DOCUMENTS_MOCKUP_KENDO_SECOND_MOCKUP_NODE_MODULES__PROGRESS_KENDO_ANGULAR_LAYOUT_FESM2022_PROGRESS_KENDO_ANGULAR_LAYOUT_MJS_6;
      } else {
...
//# sourceMappingURL=chunk-6D4CKU3G.js.map
