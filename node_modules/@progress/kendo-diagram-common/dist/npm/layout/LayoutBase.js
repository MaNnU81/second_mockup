...
class LayoutBase {
    constructor() {
        this.defaultOptions = { ...exports.LayoutDefaultOptions, grid: { ...exports.LayoutDefaultOptions.grid } };
    }
    /**
    ...
    gridLayoutComponents(components) {
        ...
        (0, utils_1.forEach)(components, function (c) {
            c.calcBounds();
        });
        ...
        while (components.length > 0) {
            ...
            this.moveToOffset(component, new Shapes_1.Point(x, y));
    ...
    moveToOffset(component, p) {
        ...
        for (i = 0; i < component.nodes.length; i++) {
            ...
            if (nodeBounds.width === 0 && nodeBounds.height === 0 && nodeBounds.x === 0 && nodeBounds.y === 0) {
                nodeBounds = new Shapes_1.Rect(0, 0, 0, 0);
            }
            nodeBounds.x += deltaX;
            nodeBounds.y += deltaY;
        ...
        return new Shapes_1.Point(deltaX, deltaY);
    }
    transferOptions(options) {
        // Size options lead to stackoverflow and need special handling
        this.options = (0, deep_extend_1.deepExtend)({}, this.defaultOptions);
