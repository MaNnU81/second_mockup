...
class Group extends Element_1.Element {
     ...
     */
    constructor(options) {
        options = (0, deep_extend_1.deepExtend)({ autoSize: false }, options);
        super(options);
        /**
    ...
    _reorderChildren(visuals, indices) {
        ...
        const fixedPosition = (0, utils_1.isNumber)(indices);
    ...
    _boundingBox() {
        ...
        for (let i = 0; i < children.length; i++) {
            ...
            if (visual.visible() && visual._includeInBBox !== false) {
                ...
                if (childBoundingBox) {
                    if (boundingBox) {
                        boundingBox = kendo_drawing_1.geometry.Rect.union(boundingBox, childBoundingBox);
                    }
                    else {
